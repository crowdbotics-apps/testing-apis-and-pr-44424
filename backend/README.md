...
## Project Structure
    ...
    ├── testing_apis_and_pr_44424  # Django project configurations
...
1. Clone this repo and `cd testing_apis_and_pr_44424`
...
2. Clone this repo and `cd testing_apis_and_pr_44424`
